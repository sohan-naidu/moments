                            ...
                            (this.prototype.defaultOptions = {
                                ...
                                addedfile: function (a) {
                                    ...
                                    if ((this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer)) {
                                        ...
                                        for (var d = a.previewElement.querySelectorAll("[data-dz-alt-text]"), e = 0, d = d; ; ) {
                                            var f;
                                            if (e >= d.length) break;
                                            f = d[e++];
                                            var g = f;
                                            g.value = "this is alt-text";
                                        }
                                    }
                                },
                                        ...
                                        g(function (e) {
                                            ...
                                            switch (((j.width = g.trgWidth), (j.height = g.trgHeight), e > 4 && ((j.width = g.trgHeight), (j.height = g.trgWidth)), e)) {
                                                ...
                                                case 5:
                                                    ...
                                                    break;
                                                case 6:
                                                    k.rotate(0.5 * Math.PI), k.translate(0, -j.height);
                                                    break;
                                                case 7:
                                                    k.rotate(0.5 * Math.PI), k.translate(j.width, -j.height), k.scale(-1, 1);
                                                    break;
                                                case 8:
                                                    k.rotate(-0.5 * Math.PI), k.translate(-j.width, 0);
                                            }
